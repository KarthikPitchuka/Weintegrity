                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="relative">
                                ...
                                {notificationDropdownOpen && (
                                    <div className="absolute right-0 mt-4 w-80 bg-white rounded-2xl shadow-2xl border border-slate-200 py-2 animate-scaleIn origin-top-right ring-1 ring-black/5 z-50">
                            ...
                            <div className="relative">
                                ...
                                {profileDropdownOpen && (
                                    <div className="absolute right-0 mt-4 w-64 bg-white rounded-2xl shadow-2xl border border-slate-200 py-2 animate-scaleIn origin-top-right ring-1 ring-black/5 z-50">
